                ...
                return pokemones.map((p, i) => html`
                    ...
                    <div class="card--list d-flexx d-col">
                        <span class="types">
                            ...
                            ${p.tipos.map(ti => html`<small>${ti}</small>`)}
                        </span>
                        <figure class="">
                            <img alt="${p.nombre}" src="https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokemon/other/home/${p.id}.png" class="">
                        </figure>
                        <hr>
                        <span class="name">
                        ...
                        <span class="btns-interact">
                            <button @click=${this._deletePoke} class="btn-general btn-card btn-edit d-flexx d-row" data-id="${i}">
