...
import { getLocal } from "../../utils/common.js";
                    ...
                    <div class="card--list d-flexx d-col">
                        <span class="types">
                            ...
                            ${
                                p.tipos.map(ti => 
                                    html`
                                        <small class="d-flexx" style="background-color: ${this.objectTypes[ti].color};"> ${unsafeHTML(this.objectTypes[ti].icon)}  ${this.objectTypes[ti].name}</small>
                                    `
                                )
                            }
                        </span>
